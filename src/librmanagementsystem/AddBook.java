...
public class AddBook extends JFrame implements  ActionListener{
	...
	comboBox.setModel(new DefaultComboBoxModel(new String[] {"Choose Editon","1", "2", "3", "4", "5", "6", "7", "8", "9" }));
    ...
    public void actionPerformed(ActionEvent ae){
         try{
            conn con=new conn();
            if(ae.getSource()==b1){
                String sql="insert into book(book_id, name, isbn, author, edition, price, pages) values(?,?,?,?,?,?,?)";
                ...
                if(rs>0){
                    ...
                    JOptionPane.showMessageDialog(null,"Could not add book,try again");
                }
            }
           if(ae.getSource()==b2){
