        ...
        try{
            ...
            if(ae.getSource()==b1){
                ...
                while(res.next()){
                    ...
                    t3.setText(res.getString("isbn"));
                    t4.setText(res.getString("author"));
                    t5.setText(res.getString("edition"));
                    t6.setText(res.getString("price"));
                    t7.setText(res.getString("pages"));
                ...
                if(ae.getSource()==b3){
                    String sql3 = "insert into issueBook(book_id, student_id, bname, sname, course, branch, dateOfIssue) values(?, ?, ?, ?, ?, ?, ?)";
                    PreparedStatement st3 = con.c.prepareStatement(sql3);
                    st3.setString(1, t1.getText());
                    st3.setString(2, t8.getText());
                    st3.setString(3, t2.getText());
                    st3.setString(4, t9.getText());
                    st3.setString(5, t11.getText());
                    st3.setString(6, t12.getText());
                    String date=dateChooser.getDate().toString();
                    date=date.substring(4,10)+", "+date.substring(24,28);
                    st3.setString(7,date);
                    int i = st3.executeUpdate();
                    if (i > 0)
                        JOptionPane.showMessageDialog(null, "Book Issued Successfully!");
                    else
                        JOptionPane.showMessageDialog(null, "Could no issue, try again!");
                }
